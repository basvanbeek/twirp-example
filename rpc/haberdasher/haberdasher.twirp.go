...
func (c *haberdasherProtobufClient) MakeHat(ctx context.Context, in *Size) (*Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "basvanbeek.twirp.example.haberdasher")
...
const HaberdasherPathPrefix = "/twirp/basvanbeek.twirp.example.haberdasher.Haberdasher/"
...
func (s *haberdasherServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/basvanbeek.twirp.example.haberdasher.Haberdasher/MakeHat":
